...
<style>
/* Стили для персонализированных цен на главной странице */
.product-card .price-with-discount-home {
    display: flex;
...
.product-card .price-with-discount-home .original-price-home {
    font-size: 14px;
    color: #9CA3AF;
    font-weight: 400;
}

.product-card .price-with-discount-home .original-price-home del {
    text-decoration: line-through;
}

.product-card .price-with-discount-home .personal-price-home {
    font-size: 18px;
    font-weight: 700;
    color: #059669;
}

.product-card .price-with-discount-home .personal-price-home .woocommerce-Price-amount {
    color: #059669;
}

.product-card .price-with-discount-home .discount-label-home {
