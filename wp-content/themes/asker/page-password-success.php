<?php
/**
 * Template Name: Успешное подтверждение пароля
 * Страница успешного подтверждения почты и установки пароля
 */
...
<div class="registration-success-page">
    <div class="container">
        <div class="registration-success__card">
            ...
            <!-- Заголовок -->
            <h1 class="registration-success__title">Пароль установлен</h1>
            
            <!-- Текст -->
            <div class="registration-success__content">
                <p>Благодарим Вас за подтверждение почты и установку пароля на сайте Asker-corp.ru.</p>
                
                <p>В настоящий момент мы проверяем введённые данные для вашей безопасности. Сразу после завершения проверки вы получите уведомление и сможете войти в личный кабинет.</p>
